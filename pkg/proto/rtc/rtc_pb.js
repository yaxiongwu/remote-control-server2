...
proto.rtc.RegisterRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.rtc.Role} */ (reader.readEnum());
      msg.setRole(value);
      break;
    case 4:
 ...
 * @return {!proto.rtc.Role}
 */
proto.rtc.RegisterRequest.prototype.getRole = function() {
  return /** @type {!proto.rtc.Role} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.rtc.Role} value
 * @return {!proto.rtc.RegisterRequest} returns this
 */
proto.rtc.RegisterRequest.prototype.setRole = function(value) {
